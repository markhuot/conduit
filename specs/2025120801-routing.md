...
│   │   ├── response.ts          # Framework-agnostic response helpers
│   │   ├── react/               # React-specific utilities
│   │   │   ├── response.tsx    # React SSR helpers (ui function)
│   │   │   └── README.md       # React utilities documentation
│   │   └── vue/                 # Vue-specific utilities (future)
│   │       └── README.md       # Vue utilities documentation
...
│   │   ├── home.tsx             # GET / (Phase 2) - SSR React homepage
│   │   ├── posts/               # Blog post handlers (reference)
│   │   │   ├── list.ts          # GET /posts
│   │   │   ├── show.ts          # GET /posts/:slug
│   │   │   ├── create.ts        # POST /posts
│   │   │   ├── update.ts        # PUT /posts/:id
│   │   │   └── destroy.ts       # DELETE /posts/:id
│   │   ├── authors/             # Author handlers (reference)
│   │   │   ├── list.ts          # GET /authors
│   │   │   ├── show.ts          # GET /authors/:slug
│   │   │   ├── create.ts        # POST /authors
│   │   │   ├── update.ts        # PUT /authors/:id
│   │   │   └── destroy.ts       # DELETE /authors/:id
│   │   ├── categories/          # Category handlers (reference)
│   │   │   ├── list.ts          # GET /categories
│   │   │   ├── show.ts          # GET /categories/:slug
│   │   │   └── posts.ts         # GET /categories/:slug/posts
│   │   ├── media/               # Media/asset handlers (reference)
│   │   │   ├── upload.ts        # POST /media
│   │   │   ├── show.ts          # GET /media/:id
│   │   │   └── destroy.ts       # DELETE /media/:id
│   │   └── schemas/             # Schema management (reference)
│   │       ├── list.ts          # GET /api/schemas
│   │       ├── show.ts          # GET /api/schemas/:id
│   │       ├── create.ts        # POST /api/schemas
│   │       ├── update.ts        # PUT /api/schemas/:id
│   │       └── destroy.ts       # DELETE /api/schemas/:id
│   │
...
2. **Extensibility**: The `ui()` function abstracts SSR complexity:
   - Automatic HTML document wrapping
   - Customizable metadata
   - Future-proof for streaming, hydration, etc.
   - Users call `ui(<Component />)` without manual HTML strings

3. **Import Clarity**: Import path reveals intent:
